/* Alexa demo for FUN - https://www.linkedin.com/feed/update/urn:li:activity:6457839967430410240/ */
...
const data = [
  {StateName: 'Winnie', Abbreviation: 'Black Widow', Capital: 'Beautiful and Intelligent', StatehoodYear: 1999, StatehoodOrder: 1},
  {StateName: 'Suresh', Abbreviation: 'Iron Man', Capital: 'Persistent and hard working', StatehoodYear: 2000, StatehoodOrder: 2},
  {StateName: 'Sidhant', Abbreviation: 'Mr. Dash', Capital: 'his wisdom and skills', StatehoodYear: 2011, StatehoodOrder: 3},
  {StateName: 'Walter', Abbreviation: 'Mr. Funny ', Capital: 'nothing, he is pretty useless but funny', StatehoodYear: 2014, StatehoodOrder: 4},
  {StateName: 'Geen', Abbreviation: 'Mr. Unbreakable', Capital: 'leadership and trusting his people', StatehoodYear: 1995, StatehoodOrder: 5},
  {StateName: 'Vinod', Abbreviation: 'Mr Almighty', Capital: 'communications and good memory', StatehoodYear: 1989, StatehoodOrder: 6},
  {StateName: 'Manjunath', Abbreviation: 'Mr www homepage ', Capital: 'knows everything about www home page site', StatehoodYear: 2001, StatehoodOrder: 7},
  {StateName: 'Catus', Abbreviation: 'Mr Management Consultant', Capital: 'can improve your company 10 times better', StatehoodYear: 1988, StatehoodOrder: 8},
  {StateName: 'Herrick', Abbreviation: 'Mr. Best engineer', Capital: 'knows technical 100 times more than Walter', StatehoodYear: 1999, StatehoodOrder: 9},
 ];
...
const welcomeMessage = `Welcome to the New Avenger team Quiz Game!  You can ask me about any of the Avengers and their strength, or you can ask me to start a quiz.  What would you like to do?`;
const startQuizMessage = `OK.  I will ask you 10 questions about the Avengers. `;
const exitSkillMessage = `Thank you for playing the Avengers Quiz Game!  Let's play again soon!`;
const repromptSpeech = `Which other Avenger or stength would you like to know about?`;
const helpMessage = `I know lots of things about the Avengers.  You can ask me about a Avenger or stength, and I'll tell you what I know.  You can also test your knowledge by asking me to start a quiz.  What would you like to do?`;
...
function getSpeechDescription(item) {
  return `${item.StateName} is the ${item.StatehoodOrder}th team member, admitted to the Avenger Dream Team in ${item.StatehoodYear}.  The strength of ${item.StateName} is ${item.Capital}, and the abbreviation for ${item.StateName} is ${item.Abbreviation}. ${item.StateName} is the MVP in Avenger.  Which other team member would you like to know about?`;
}
